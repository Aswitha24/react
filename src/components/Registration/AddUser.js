                    ...
                    <div className="row">
                        <div className="col-md-4 m-auto">
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <input type="submit"  value="Sign Up"  className="btn btn-primary btn btn-info" />
                              
    
                                <br/>
                                <br/>
                                <small><h6 >Already Have an Account? <Link to={"/login"} className="btn btn-info"> Login </Link></h6></small>
